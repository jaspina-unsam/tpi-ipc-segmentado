...
\begin{frame}{Fuentes (hasta el momento)}
    \begin{itemize}
        \item Entrevista: \small Germán Rosati, Doctor en Ciencias Sociales, investigador del CONICET y profesor de la UNSAM.
...
\begin{frame}{IPC heterogéneo y Ciencia de Datos}
...
\begin{itemize}
    \item \textbf{ENGHo} --- Encuesta Nacional de Gastos de los Hogares. Base puntual, con información detallada sobre consumo, ingresos, características del hogar, etc. Se realiza cada $\sim$10 años.
...
\begin{block}{Los datos en la revisión de fuentes}
    \small{Jaravel usa la \textbf{Consumer Expenditure Survey} de los Estados Unidos, con estructura similar a la ENGHo. Difieren en la frecuencia de recolección (trimestral vs. cada $\sim$10 años).\\
...
\centering\includegraphics[width=0.85\textheight]{suzuki_perf.png}

\centering\includegraphics[width=0.85\textheight]{donatiello_perf.png}
...
\begin{itemize}
    ...
    \item La estabilidad de los perfiles encontrados en un momento puntual deben ser asumidos como suficientemente estables para ser considerados perfiles de largo plazo.
\end{itemize}
\end{frame}
